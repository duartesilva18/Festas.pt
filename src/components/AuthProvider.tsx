...
type AuthContexto = {
  ...
  alternar: (festaId: string) => Promise<"guardado" | "removido" | "login" | "erro">;
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const alternar = useCallback(
    async (festaId: string) => {
      ...
      if (error) {
        void carregarFavoritos(u.id); // reverte para o estado real
        return "erro";
      }
      return jaGuardado ? "removido" : "guardado";
    },
